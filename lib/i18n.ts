...
export const translations = {
  fr: {
    ...
    auth_login_subtitle: "Bienvenue sur Safra. Connectez-vous pour continuer.",
    auth_register_subtitle: "Rejoignez des milliers de voyageurs et propriétaires sur Safra.",
    auth_forgot_password: "Mot de passe oublié ?",
    auth_invalid_credentials: "Email ou mot de passe incorrect",
    auth_error: "Une erreur est survenue. Veuillez réessayer.",
    auth_password_too_short: "Le mot de passe doit contenir au moins 6 caractères",
    auth_email_exists: "Cet email est déjà utilisé",
    auth_host_docs_required: "Documents requis pour les hôtes",
    auth_host_docs_info: "Après votre inscription, vous devrez fournir un acte de propriété ou un document officiel pour valider votre compte hôte.",
    ...
    auth_host_cta_title: "Partagez votre logement",
    auth_host_cta_subtitle: "Rejoignez notre communauté d'hôtes et générez des revenus supplémentaires",
    auth_send_otp: "Recevoir le code de vérification",
    auth_verify_email: "Vérifiez votre email",
    auth_otp_sent_to: "Un code de vérification a été envoyé à",
    auth_otp_invalid: "Code de vérification invalide ou expiré",
    auth_verify_and_create: "Vérifier et créer le compte",
    auth_didnt_receive_code: "Vous n'avez pas reçu le code ?",
  ...
  en: {
    ...
    auth_otp_sent_to: "A verification code was sent to",
    auth_otp_invalid: "Invalid or expired verification code",
    auth_verify_and_create: "Verify and create account",
    auth_didnt_receive_code: "Didn't receive the code?",
  ...
  ar: {
    ...
    auth_otp_sent_to: "تم إرسال رمز التحقق إلى",
    auth_otp_invalid: "رمز التحقق غير صالح أو منتهي الصلاحية",
    auth_verify_and_create: "تحقق وأنشئ الحساب",
    auth_didnt_receive_code: "لم تستلم الرمز؟",
